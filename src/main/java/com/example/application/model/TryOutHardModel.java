...
public class TryOutHardModel {
    private int idSoalToHard;
    private int noSoal;
    private int idMapel;
    private int idMateri;
    private String pertanyaan;
    private int idJawabanToHard;
    private String opsi;
    ...
    public void setIdSoalToHard(int idSoalToHard) {
        this.idSoalToHard = idSoalToHard;
    }
    ...
    public void setIdJawabanToHard(int idJawabanToHard) {
        this.idJawabanToHard = idJawabanToHard;
    }
