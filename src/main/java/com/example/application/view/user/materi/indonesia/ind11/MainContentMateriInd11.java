package com.example.application.view.user.materi.indonesia.ind11;
...
@Route("materi-ind-11")
@PageTitle("Materi - Indonesia - 11")
public class MainContentMateriInd11 extends VerticalLayout implements BeforeEnterObserver, MateriClickListener {

    private VerticalLayout mainContent;

    public MainContentMateriInd11() {}
    ...
    private void buildLayout() {
        ...
        HorizontalLayout header = Header.headerWithBackButton("Indonesia kelas 11");
    ...
    private VerticalLayout createMainContent() {
        ...
        List<ModelMateriInd> daftarMateri = DaftarMateriInd11.getDaftarMateriInd11();
        ...
        btnLatsol.addClickListener(buttonClickEvent -> {
            try {
                if (materiInd.getIdMateri() > 0) {
                    UI.getCurrent().navigate("latsol-ind-11/" + materiInd.getIdMateri());
                } else {
    ...
    public void onMateriClick(String judul) {
        ...
        ModelMateriInd materiTerpilih = DaftarMateriInd11.getDaftarMateriInd11().stream()
