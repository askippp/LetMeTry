...
@Route("latsol-mtk-12/:idMateri")
@PageTitle("Latihan Soal Mtk 12")
public class LatsolMtk12 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriMtk12.getDaftarMateriMtk12().stream()
        ...
        if (questionNumber >= getTotalQuestions()) {
            ...
            submitButton.addClickListener(e -> {
                try {
                    ...
                    UI.getCurrent().navigate("materi-mtk-12");
