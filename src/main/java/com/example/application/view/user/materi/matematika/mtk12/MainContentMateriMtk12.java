...
@Route("materi-mtk-12")
@PageTitle("Materi - Matematika - 12")
public class MainContentMateriMtk12 extends VerticalLayout implements BeforeEnterObserver, MateriClickListener {

    private VerticalLayout mainContent;

    public MainContentMateriMtk12() {}
    ...
    private void buildLayout() {
        ...
        HorizontalLayout header = Header.headerWithBackButton("Matematika Kelas 12");
        ...
        onMateriClick("Aturan Pencacahan dan Peluang");
    }
    ...
    private VerticalLayout createMainContent() {
        ...
        List<ModelMateriMtk> daftarMateri = DaftarMateriMtk12.getDaftarMateriMtk12();
        ...
        btnLatsol.addClickListener(buttonClickEvent -> {
            try {
                if (materiMtk.getIdMateri() > 0) {
                    UI.getCurrent().navigate("latsol-mtk-12/" + materiMtk.getIdMateri());
                } else {
    ...
    public void onMateriClick(String judul) {
        ...
        ModelMateriMtk materiTerpilih = DaftarMateriMtk12.getDaftarMateriMtk12().stream()
