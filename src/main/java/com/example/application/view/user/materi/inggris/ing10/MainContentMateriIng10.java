...
@Route("materi-ing-10")
@PageTitle("Materi - Inggris - 10")
public class MainContentMateriIng10 extends VerticalLayout implements BeforeEnterObserver, MateriClickListener {

    private VerticalLayout mainContent;

    public MainContentMateriIng10() {}
    ...
    private VerticalLayout createMainContent() {
        ...
        List<ModelMateriIng> daftarMateri = DaftarMateriIng10.getDaftarMateriIng10();
        ...
        btnLatsol.addClickListener(buttonClickEvent -> {
            try {
                if (materiIng.getIdMateri() > 0) {
                    UI.getCurrent().navigate("latsol-ing-10/" + materiIng.getIdMateri());
                } else {
    ...
    public void onMateriClick(String judul) {
        ...
        ModelMateriIng materiTerpilih = DaftarMateriIng10.getDaftarMateriIng10().stream()
