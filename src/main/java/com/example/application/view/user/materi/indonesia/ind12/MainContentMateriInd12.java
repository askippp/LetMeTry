package com.example.application.view.user.materi.indonesia.ind12;
...
@Route("materi-ind-12")
@PageTitle("Materi - Indonesia - 12")
public class MainContentMateriInd12 extends VerticalLayout implements BeforeEnterObserver, MateriClickListener {

    private VerticalLayout mainContent;

    public MainContentMateriInd12() {}
    ...
    private void buildLayout() {
        ...
        HorizontalLayout header = Header.headerWithBackButton("Indonesia kelas 12");
    ...
    private VerticalLayout createMainContent() {
        ...
        List<ModelMateriInd> daftarMateri = DaftarMateriInd12.getDaftarMateriInd12();
        ...
        btnLatsol.addClickListener(buttonClickEvent -> {
            try {
                if (materiInd.getIdMateri() > 0) {
                    UI.getCurrent().navigate("latsol-ind-12/" + materiInd.getIdMateri());
                } else {
    ...
    public void onMateriClick(String judul) {
        ...
        ModelMateriInd materiTerpilih = DaftarMateriInd12.getDaftarMateriInd12().stream()
