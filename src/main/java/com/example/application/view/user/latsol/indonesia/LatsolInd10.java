...
@Route("latsol-ind-10/:idMateri")
@PageTitle("Latihan Soal Indonesia 10")
public class LatsolInd10 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriInd10.getDaftarMateriInd10().stream()
    ...
    private void displayQuestion(int questionNumber) {
        ...
        if (questionNumber >= getTotalQuestions()) {
            ...
            submitButton.addClickListener(e -> {
                UI.getCurrent().navigate("hasil-latsol/" + idLatsol);
            });
