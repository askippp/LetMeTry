...
import com.example.application.view.user.materi.indonesia.ind11.DaftarMateriInd11;
...
@Route("latsol-ind-11/:idMateri")
@PageTitle("Latihan Soal Indonesia 11")
public class LatsolInd11 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriInd11.getDaftarMateriInd11().stream()
