...
@Route("materi-ing-11")
@PageTitle("Materi - Inggris - 11")
public class MainContentMateriIng11 extends VerticalLayout implements BeforeEnterObserver, MateriClickListener {

    private VerticalLayout mainContent;

    public MainContentMateriIng11() {}
    ...
    private void buildLayout() {
        ...
        HorizontalLayout header = Header.headerWithBackButton("Inggris kelas 11");
    ...
    private VerticalLayout createMainContent() {
        ...
        List<ModelMateriIng> daftarMateri = DaftarMateriIng11.getDaftarMateriIng11();
        ...
        btnLatsol.addClickListener(buttonClickEvent -> {
            try {
                if (materiIng.getIdMateri() > 0) {
                    UI.getCurrent().navigate("latsol-ing-11/" + materiIng.getIdMateri());
                } else {
    ...
    public void onMateriClick(String judul) {
        ...
        ModelMateriIng materiTerpilih = DaftarMateriIng11.getDaftarMateriIng11().stream()
