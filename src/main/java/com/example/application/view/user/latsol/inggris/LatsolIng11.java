...
import com.example.application.view.user.materi.inggris.ing11.DaftarMateriIng11;
import com.example.application.view.user.materi.matematika.ModelMateriMtk;
import com.example.application.view.user.materi.matematika.mtk11.DaftarMateriMtk11;
...
@Route("latsol-ing-11/:idMateri")
@PageTitle("Latihan Soal Inggris 11")
public class LatsolIng11 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriIng11.getDaftarMateriIng11().stream()
        ...
        if (questionNumber >= getTotalQuestions()) {
            ...
            submitButton.addClickListener(e -> {
                try {
                    ...
                    UI.getCurrent().navigate("materi-ing-11");
