...
@Route("materi-mtk-10")
@PageTitle("Materi - Matematika - 10")
public class MainContentMateriMtk10 extends VerticalLayout implements BeforeEnterObserver, MateriClickListener {

    private VerticalLayout mainContent;

    public MainContentMateriMtk10() {}
    ...
    private VerticalLayout createMainContent() {
        ...
        List<ModelMateriMtk> daftarMateri = DaftarMateriMtk10.getDaftarMateriMtk10();
        ...
        btnLatsol.addClickListener(buttonClickEvent -> {
            try {
                if (materiMtk.getIdMateri() > 0) {
                    UI.getCurrent().navigate("latsol-mtk-10/" + materiMtk.getIdMateri());
                } else {
    ...
    public void onMateriClick(String judul) {
        ...
        ModelMateriMtk materiTerpilih = DaftarMateriMtk10.getDaftarMateriMtk10().stream()
