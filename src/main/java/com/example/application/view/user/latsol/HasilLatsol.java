package com.example.application.view.user.latsol;
...
@Route("hasil-latsol/:idLatsol?")  // Mengubah route untuk menerima parameter
@PageTitle("Hasil Latihan Soal")
public class HasilLatsol extends VerticalLayout implements BeforeEnterObserver, HasUrlParameter<String> {
    ...
    private void buildLayout() {
        ...
        H3 title = new H3("Latihan Soal LetMeTry");
