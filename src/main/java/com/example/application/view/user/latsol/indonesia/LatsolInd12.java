package com.example.application.view.user.latsol.indonesia;
...
import com.example.application.view.user.materi.indonesia.ind10.DaftarMateriInd10;
import com.example.application.view.user.materi.indonesia.ind12.DaftarMateriInd12;
...
@Route("latsol-ind-12/:idMateri")
@PageTitle("Latihan Soal Indonesia 12")
public class LatsolInd12 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriInd12.getDaftarMateriInd12().stream()
                        .filter(m -> m.getIdMateri() == idMateri)
                        .findFirst()
                        .map(ModelMateriInd::getJudul)
                        .orElse(null);
        ...
        if (questionNumber >= getTotalQuestions()) {
            ...
            submitButton.addClickListener(e -> {
                try {
                    ...
                    UI.getCurrent().navigate("materi-ind-12");
