...
@PageTitle("Latihan Soal Inggris 10")
public class LatsolIng10 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriIng10.getDaftarMateriIng10().stream()
        ...
        if (questionNumber >= getTotalQuestions()) {
            ...
            submitButton.addClickListener(e -> {
                try {
                    ...
                    UI.getCurrent().navigate("materi-ing-10");
