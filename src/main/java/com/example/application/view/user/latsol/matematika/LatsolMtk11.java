...
@Route("latsol-mtk-11/:idMateri")
@PageTitle("Latihan Soal Mtk 11")
public class LatsolMtk11 extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (user == null) {
            ...
            try {
                ...
                materiJudul = DaftarMateriMtk11.getDaftarMateriMtk11().stream()
        ...
        if (questionNumber >= getTotalQuestions()) {
            ...
            submitButton.addClickListener(e -> {
                try {
                    ...
                    UI.getCurrent().navigate("materi-mtk-11");
