...
public class SidebarUser {
    ...
    public static VerticalLayout createSidebar() {
        ...
        Button dashboardBtn = createNavButton("Dashboard", "images/dashboard.png", "dashboard");
        Button historyBtn = createNavButton("My History", "images/historyicon.png", "my-history");
        Button rankingBtn = createNavButton("Ranking", "images/rank.png", "rankings");

        dashboardBtn.getStyle().setMarginTop("40px");
        ...
        sidebar.add(dashboardBtn, historyBtn, rankingBtn, logoutBtn);
